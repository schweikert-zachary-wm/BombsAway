...
namespace BombsAway
{
    public partial class Form1 : Form
    {
        ...
        Boolean Player_Down = false; //.. moving to the left
        ...
        private void debug_MGravity_Click_1(object sender, EventArgs e)
        {
            Gravity = 0;
        }
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                ...
                case Keys.Right:                // On Right Keypress down
                    ...
                    break;
                case Keys.Up:                // On Right Keypress down //lolz
                    if (GameOn)
                    {
                        if (GodMode)
                        {
                    ...
                    break;
                case Keys.Down:                // On Right Keypress down
                    if (GameOn)
                    {
                        if (GameOn)
                        {
            ...
            if (GameOn)
            {
                switch (e.KeyCode)
                {
                    ...
                    case Keys.Right:
                        ...
                        Player_Right = false;
                        break;
                    case Keys.Up:                // On Right Keypress down
                        if (GameOn)
                        {
                            if (GodMode)
                            {
        ...
        private void timer_Jump_Tick(object sender, EventArgs e)
        {
            if (GameOn) // lolz2
            {
                ...
                if (Player_Up && pb_Player.Right <= WorldFrame.Width - 3 && !Collision_Top(pb_Player))
                { //Stops the player from moving out of screen
                    pb_Player.Top -= Speed_Movement; //Moves right

                }
                if (Player_Down && pb_Player.Location.X >= 3 && !Collision_Bottom(pb_Player))
                { //Stops the player from moving out of screen
                    pb_Player.Top -= Speed_Movement; //Moves left
                }




                if (Collision_Right(pb_Player))
                { //Stops the player from moving out of screen
                    this.Close(); //Moves left
                }
